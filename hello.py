...
@st.cache
def get_states():
  with urllib.request.urlopen('https://gist.githubusercontent.com/mshafrir/2646763/raw/8b0dbb93521f5d6889502305335104218454c2bf/states_hash.json') as response:
...
raw_pharmacy_data = fetch_json("https://arcos-api.ext.nile.works/v1/total_pharmacies_state?state={state}&key=WaPo".format(state=state))
...
aapl = fetch_csv('https://gist.githubusercontent.com/mbostock/14613fb82f32f40119009c94f5a46d72/raw/d0d70ffb7b749714e4ba1dece761f6502b2bdea2/aapl.csv')
...
raw_la_schools = fetch_csv("https://github.com/datadesk/highschool-homicide-analysis/raw/master/output/la-high-schools.csv")
